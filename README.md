...
<mark>特别注意：本汉化版不支持默认编码是UTF8的win系统（显示乱码），目前绝大部分windows系统中文版都是GBK/GB2312的默认编码。仅制作了26.0的UTF8编码测试版，将来应该不会更新</mark>
...
（注：26.0版开始官方新增快速连接、临时会话（livesession）的相关功能和帮助界面，为了兼容，部分选项的汉化做了调整或者取消。若介意，建议使用25.4版）
